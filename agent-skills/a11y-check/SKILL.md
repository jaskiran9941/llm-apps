...
name: a11y-check
description: |
  Review a Figma design screenshot for accessibility issues across contrast, labeling,
  touch targets, hierarchy, and keyboard navigability. Use when: auditing UI designs for
  WCAG compliance, checking accessibility before dev handoff, or identifying barriers for
