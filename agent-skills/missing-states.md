# Skill: /missing-states

Analyze a Figma design screenshot and enumerate all UI states that are likely missing or not yet mocked.
...
### Systematically check for the following state categories:
