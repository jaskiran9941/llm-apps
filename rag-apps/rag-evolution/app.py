...
<style>
    ...
    .problem-box h4, .problem-box b, .problem-box li, .problem-box p {
        color: #333;
    }
    .solution-box {
    ...
    .solution-box h4, .solution-box b, .solution-box li, .solution-box p {
        color: #333;
    }
    .info-box {
    ...
    .info-box h4, .info-box b, .info-box li, .info-box p {
        color: #333;
    }
    .metric-card {
