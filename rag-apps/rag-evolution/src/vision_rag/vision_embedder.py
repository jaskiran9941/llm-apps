...
class VisionEmbedder:
    ...
    def describe_image(self, image_path: str) -> str:
        ...
        try:
            ...
            # Call GPT-4 Vision with timeout to prevent hanging
...
Be thorough and precise."""
            ...
            error_msg = f"Error describing image {image_path}: {e}"
            print(error_msg)
            # Return a marked failure description that can be detected by callers
            return f"[DESCRIPTION_FAILED] {error_msg}"
