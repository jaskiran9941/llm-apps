...
class TableExtractor:
        ...
        try:
            ...
            for sheet_index, sheet_name in enumerate(excel_file.sheet_names):
                try:
                    ...
                    # Accept tables with at least 1 column and 1 row
    ...
    def extract_from_csv(self, csv_path: Path) -> List[TableInfo]:
        ...
        try:
            ...
            if not df.empty and len(df.columns) >= 1:
                ...
                logger.warning(f"CSV file is empty or has no valid data")
    ...
    def _create_table_info(
        ...
        # Serialize DataFrame as dict (column -> list of values)
